...
- Simplifying the amount of visuals needed, especially due to the limited timeline of the single-person Capstone project
- Research questions seem very broad. Maybe more direct questions, like the ones in the planned analysis section
- A little more detail about the machine learning going to be used for your categorical data from the survey data
